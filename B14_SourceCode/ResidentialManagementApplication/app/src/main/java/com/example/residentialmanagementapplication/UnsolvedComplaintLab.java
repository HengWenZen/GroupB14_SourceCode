...
public class UnsolvedComplaintLab {
    private static UnsolvedComplaintLab sComplaintLab;
    private List<Complaint> mComplaints;
    Firebase database = new Firebase();

    public static UnsolvedComplaintLab get(Context context){

        sComplaintLab = new UnsolvedComplaintLab(context);
        return sComplaintLab;
    }

    private UnsolvedComplaintLab(Context context) {
...
//                            Log.d("firebase 12", (String) map.get("firstName"));
    ...
    public Complaint getUnsolvedComplaint(UUID id){
